...
<div class="page-wrapper">
  <div class="page-content">
    ...
    <!--end breadcrumb-->
      ...
      <div class="card">
      <form class="" action="{{route('product.update',$product[0]->id)}}"  enctype="multipart/form-data" method="post">
        @method('PATCH')
        @csrf
        <div class="card-body p-4">
          <h5 class="card-title">Editar Producto {{$product[0]->title}} </h5>
          <hr/>
                     <div class="form-body mt-4">
            <div class="row">
              <div class="col-lg-4">
                <div class="mb-3">
                  <img src="{{url('/')}}/assets/images/products/{{$product[0]->photo}}" alt="">
                </div>
                <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" name="title" value="{{$product[0]->title}}" class="form-control" id="inputProductTitle" placeholder="Nombre del producto">
              </div>
              <div class="mb-3">
              <label for="inputProductDescription" class="form-label">Descripcion</label>
              <textarea name="description" class="form-control" id="inputProductDescription" rows="3">{{$product[0]->description}}</textarea>
              </div>
                          </div>
             </div>
             <div class="col-lg-4">
